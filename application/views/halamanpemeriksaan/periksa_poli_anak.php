...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
              <!-- Default box -->
              <form action="<?php echo base_url('HalamanPemeriksaan/input_periksa_poli_anak') ?>" method="POST">
              <div class="card">
                ...
                <div class="card-footer">
                  <a href="<?php echo base_url('HalamanPemeriksaan/poli_anak')?>"  class="btn btn-warning">Kembali</a>
