...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
              <!-- Default box -->
              <form action="<?php echo base_url('HalamanPemeriksaan/input_periksa_poli_tb') ?>" method="POST">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="">Kls/Type</label>
                    <input type="text" class="form-control" id="kelas" name="kelas" required>
                  </div>
                  <div class="form-group">
                    <label for="">Tgl Berobat</label>
                    <input type="date" class="form-control" id="tgl_berobat" name="tgl_berobat" required>
                  </div>
                  <div class="form-group">
                    <label for="">Memori Hasil</label>
                    <input type="text" class="form-control" id="memori_hasil" name="memori_hasil" required>
                  </div>
                ...
                <div class="card-footer">
                  <a href="<?php echo base_url('HalamanPemeriksaan/poli_tb')?>"  class="btn btn-warning">Kembali</a>
