          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Data Poli Umum Bulan</h3>
                  ...
                  <div class="col-md-12 pb-3">    
                    <form action="<?= base_url('HalamanPemeriksaan/filter_bulan_umum') ?>" method="post">
                      <div class="row">
                        ...
                        <div class="col">
                          <a href="<?php echo base_url('HalamanPemeriksaan/laporan_poliumum_bulan/') . $tahun . '/' . $bulan ?>" target="_blank" class="btn btn-block btn-outline-success">Cetak</a>
