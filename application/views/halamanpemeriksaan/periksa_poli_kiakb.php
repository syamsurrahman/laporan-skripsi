...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
              <!-- Default box -->
              <form action="<?php echo base_url('HalamanPemeriksaan/input_periksa_poli_kiakb') ?>" method="POST">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="">HTP</label>
                    <input type="date" class="form-control" id="htp" name="htp" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <a href="<?php echo base_url('HalamanPemeriksaan/poli_kiakb')?>"  class="btn btn-warning">Kembali</a>
