          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Data Posyandu</h3>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12 pb-3">    
                    <form action="<?= base_url('HalamanPosyandu/filter_tahun_kegiatanposyandu') ?>" method="post">
                      <div class="row">
                        <div class="col-6">
                  ...
                  <!-- Filter Bulan -->
                  <div class="col-md-12 pb-3">    
                    <form action="<?= base_url('HalamanPosyandu/filter_bulan_kegiatanposyandu') ?>" method="post">
                      <div class="row">
                        <div class="col-3">
                  ...
                  <!-- Filter Tanggal -->
                  <div class="col-md-12 pb-3">    
                    <form action="<?= base_url('HalamanPosyandu/filter_tanggal_kegiatanposyandu') ?>" method="post">
                      <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col">
                          <a href="<?php echo base_url('HalamanPosyandu/laporan_kegiatanposyandu_tanggal/') . $tgl_awal . '/' . $tgl_akhir ?>" target="_blank" class="btn btn-block btn-outline-success">Cetak</a>
                        </div>
                      </div>
                    </form>
                  </div>
