                          ...
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-warning btn-sm" id="edit" type="button" data-toggle="modal" data-target="#modal-edit" 
                                ...
                                data-nama_perawat="<?php echo $data->nama_perawat ?>"
                              ...
                              <a href="<?php echo base_url('HalamanPerawat/hapus_perawat/'. $data->id_perawat)?>" class="btn btn-danger btn-sm" onclick="return confirm ('Yakin ingin menghapus data ini');">Hapus</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Input Data Perawat</h4>
            ...
            <form action="<?php echo base_url('HalamanPerawat/input_perawat') ?>" method="POST"> 
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_perawat" name="nama_perawat" placeholder="Masukan Nama Poli"required>
                </div>
                <div class="form-group">
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Awal Form -->
            <!-- Form Action Berfungsi mengarahkan Inputan u/ di Proses di Controller  -->
            <form action="<?php echo base_url('HalamanPerawat/edit_perawat') ?>" method="POST"> 
              <div class="modal-body">
                <div class="form-group">
                  <label for="">NIP</label>
                  <input type="hidden" id="edit-id_perawat" name="id_perawat">
                  <input type="text" class="form-control" id="edit-nip" name="nip" placeholder="Masukan Nama Poli">
                </div>
                <div class="form-group">
                  <label for="">Nama Perawat</label>
                  <input type="text" class="form-control" id="edit-nama_perawat" name="nama_perawat" placeholder="Masukan Nama Poli">
                </div>
                <div class="form-group">
                  <label for="">Jabatan</label>
                ...
                <div class="form-group">
                  <label for="">Poli</label>
                  <select class="form-control" name="id_poli" id="edit-id_poli" required>
...
<script>
  $(document).ready(function() {
    $(document).on('click', '#edit', function() {
      ...
      var nama_perawat = $(this).data('nama_perawat');
      ...
      $('#edit-nip').val(nip);
      $('#edit-nama_perawat').val(nama_perawat);
