          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Data Promkes Tahun <?= $tahun ?></h3>
                  ...
                  <div class="col-md-12 pb-3">    
                    <form action="<?= base_url('HalamanPromkes/filter_tahun_promkes') ?>" method="post">
                      <div class="row">
                        ...
                        <div class="col">
                          <a href="<?php echo base_url('HalamanPromkes/laporan_promkes_tahun/') . $tahun ?>" target="_blank" class="btn btn-block btn-outline-success">Cetak</a>
                        </div>
                      </div>
                    </form>
                  </div>
