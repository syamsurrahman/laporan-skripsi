          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Vaksin Covid</h3>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 pb-3">
                    ...
                    <!-- <a href="<?php echo base_url('HalamanVaksin/laporan_vaksin') ?>" class="btn btn-primary" target="_blank">Cetak Data Vaksin</a> -->
                  </div>
                  <div class="col-md-12">
                        ...
                        foreach ($vaksinasi as $data) { ?> 
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="<?php echo base_url('HalamanVaksin/hapus_vaksin/'. $data->id_vaksin)?>" class="btn btn-danger btn-sm" onclick="return confirm ('Yakin ingin menghapus data ini');">Hapus</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
