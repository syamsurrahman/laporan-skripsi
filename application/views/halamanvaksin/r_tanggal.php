          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Data Vaksinasi Covid Pertanggal</h3>
                  ...
                  <div class="col-md-12 pb-3">    
                    <form action="<?= base_url('HalamanVaksin/filter_tanggal') ?>" method="post">
                      <div class="row">
                        ...
                        <div class="col">
                          <a href="<?php echo base_url('HalamanVaksin/laporan_vaksin_tanggal/') . $tgl_awal . '/' . $tgl_akhir ?>" target="_blank" class="btn btn-block btn-outline-success">Cetak</a>
                        </div>
                      </div>
                    </form>
                  </div>
