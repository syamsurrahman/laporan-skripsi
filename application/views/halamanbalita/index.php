                      ...
                      <thead>
                        ...
                        foreach ($balita as $data) { ?>
                          <tr>
                            ...
                            <td><?php echo $data->umur ?> Bulan</td>
                            ...
                            <td>
                              ...
                              <a href="<?php echo base_url('HalamanBalita/hapus_balita/'. $data->id_balita)?>" class="btn btn-danger btn-sm" onclick="return confirm ('Yakin ingin menghapus data ini');">Hapus</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Input Data Balita</h4>
            ...
            <form action="<?php echo base_url('HalamanBalita/input_balita') ?>" method="POST"> 
              <div class="modal-body">
                <div class="form-group">
                  <label for="">Nama Balita</label>
                  <input type="text" class="form-control" id="nama_balita" name="nama_balita" placeholder="Masukan Nama Balita"required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" placeholder="Masukan Nama Ibu"required>
                </div>
                <div class="form-group">
                  <label for="">NIK Ibu</label>
                  <input type="text" class="form-control" id="nik_ibu" name="nik_ibu" placeholder="Masukan Nik Ibu"required>
                </div>
                <div class="form-group">
